#
# Module manifest for module 'PowerConfluence'
#
...
Description = 'PowerShell module to interact with the Confluence API'
...
FormatsToProcess = 'PowerConfluence.Format.ps1xml'
